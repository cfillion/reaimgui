...
API_FUNC(void, Separator, (ImGui_Context*,ctx),
...
API_FUNC(void, SeparatorText, (ImGui_Context*,ctx)
(const char*,label),
...
API_FUNC(void, SameLine, (ImGui_Context*,ctx)
...
API_FUNC(void, NewLine, (ImGui_Context*,ctx),
...
API_FUNC(void, Spacing, (ImGui_Context*,ctx),
...
API_FUNC(void, Dummy, (ImGui_Context*,ctx)(double,size_w)(double,size_h),
...
API_FUNC(void, Indent, (ImGui_Context*,ctx)(double*,API_RO(indent_w),0.0),
...
API_FUNC(void, Unindent, (ImGui_Context*,ctx)(double*,API_RO(indent_w),0.0),
...
API_FUNC(void, BeginGroup, (ImGui_Context*,ctx),
...
API_FUNC(void, EndGroup, (ImGui_Context*,ctx),
...
API_FUNC(void, GetCursorPos, (ImGui_Context*,ctx)
...
API_FUNC(double, GetCursorPosX, (ImGui_Context*,ctx),
...
API_FUNC(double, GetCursorPosY, (ImGui_Context*,ctx),
...
API_FUNC(void, SetCursorPos, (ImGui_Context*,ctx)
...
API_FUNC(void, SetCursorPosX, (ImGui_Context*,ctx)
(double,local_x),
"Cursor X position in window")
{
  FRAME_GUARD;
...
API_FUNC(void, SetCursorPosY, (ImGui_Context*,ctx)
(double,local_y),
"Cursor Y position in window")
{
  FRAME_GUARD;
...
API_FUNC(void, GetCursorStartPos, (ImGui_Context*,ctx)
(double*,API_W(x))(double*,API_W(y)),
...
API_FUNC(void, GetCursorScreenPos, (ImGui_Context*,ctx)
(double*,API_W(x))(double*,API_W(y)),
...
API_FUNC(void, SetCursorScreenPos, (ImGui_Context*,ctx)
...
API_FUNC(void, PushClipRect, (ImGui_Context*,ctx)
...
API_FUNC(void, PopClipRect, (ImGui_Context*,ctx),
"See PushClipRect")
{
  FRAME_GUARD;
  ImGui::PopClipRect();
...
API_FUNC(bool, IsRectVisible, (ImGui_Context*,ctx)
...
API_FUNC(bool, IsRectVisibleEx, (ImGui_Context*,ctx)
