...
API_FUNC(bool, DragInt, (ImGui_Context*,ctx)
...
API_FUNC(bool, DragInt2, (ImGui_Context*,ctx)
...
API_FUNC(bool, DragInt3, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(v1))(int*,API_RW(v2))
...
API_FUNC(bool, DragInt4, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(v1))(int*,API_RW(v2))
...
API_FUNC(bool, DragIntRange2, (ImGui_Context*,ctx)
...
API_FUNC(bool, DragFloatRange2, (ImGui_Context*,ctx)
...
API_FUNC(bool, DragDouble, (ImGui_Context*,ctx)
...
API_FUNC(bool, DragDouble2, (ImGui_Context*,ctx)(const char*,label)
...
API_FUNC(bool, DragDouble3, (ImGui_Context*,ctx)(const char*,label)
...
API_FUNC(bool, DragDouble4, (ImGui_Context*,ctx)(const char*,label)
(double*,API_RW(v1))(double*,API_RW(v2))(double*,API_RW(v3))
...
API_FUNC(bool, DragDoubleN, (ImGui_Context*,ctx)
...
API_FUNC(bool, SliderInt, (ImGui_Context*,ctx)
...
API_FUNC(bool, SliderInt2, (ImGui_Context*,ctx)
...
API_FUNC(bool, SliderInt3, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(v1))(int*,API_RW(v2))
...
API_FUNC(bool, SliderInt4, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(v1))(int*,API_RW(v2))
...
API_FUNC(bool, SliderDouble, (ImGui_Context*,ctx)
...
API_FUNC(bool, SliderDouble2, (ImGui_Context*,ctx)(const char*,label)
(double*,API_RW(v1))(double*,API_RW(v2))
...
API_FUNC(bool, SliderDouble3, (ImGui_Context*,ctx)(const char*,label)
(double*,API_RW(v1))(double*,API_RW(v2))(double*,API_RW(v3))
(double,v_min)(double,v_max)
(const char*,API_RO(format),"%.3f")(int*,API_RO(flags),ImGuiSliderFlags_None),
"")
...
API_FUNC(bool, SliderDouble4, (ImGui_Context*,ctx)(const char*,label)
(double*,API_RW(v1))(double*,API_RW(v2))(double*,API_RW(v3))
...
API_FUNC(bool, SliderDoubleN, (ImGui_Context*,ctx)
(const char*,label)(reaper_array*,values)
...
API_FUNC(bool, SliderAngle, (ImGui_Context*,ctx)
...
API_FUNC(bool, VSliderInt, (ImGui_Context*,ctx)
...
API_FUNC(bool, VSliderDouble, (ImGui_Context*,ctx)
...
API_ENUM(ImGui, SliderFlags_NoRoundToFormat,
...
API_ENUM(ImGui, SliderFlags_NoInput,
