...
R"(Default values: flags = ImGui_TableFlags_None, outer_size_w = 0.0, outer_size_h = 0.0, inner_width = 0.0)",
{
  FRAME_GUARD;
...
DEFINE_ENUM(ImGui, TableRowFlags_None,    "For ImGui_TableNextRow.");
...
DEFINE_SECTION(columnFlags, columns, "Column Flags", "For ImGui_TableSetupColumn.");
...
API_SECTION_P(columnFlags, "Output status", "Read-only via ImGui_TableGetColumnFlags");
