...
R"(- They block normal mouse hovering detection (and therefore most mouse interactions) behind them.
...
API_SUBSECTION("Tooltips", "Tooltip are windows following the mouse. They do not take focus away.");
