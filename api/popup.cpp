...
API_FUNC(bool, BeginPopup, (ImGui_Context*,ctx)
...
API_FUNC(bool, BeginPopupModal, (ImGui_Context*,ctx)
...
API_FUNC(void, EndPopup, (ImGui_Context*,ctx),
...
API_FUNC(void, OpenPopup, (ImGui_Context*,ctx)
...
API_FUNC(void, OpenPopupOnItemClick, (ImGui_Context*,ctx)
...
API_FUNC(void, CloseCurrentPopup, (ImGui_Context*,ctx),
...
API_FUNC(bool, IsPopupOpen, (ImGui_Context*,ctx)
...
API_ENUM(ImGui, PopupFlags_None, "");
API_ENUM(ImGui, PopupFlags_NoOpenOverExistingPopup,
...
API_FUNC(bool, BeginPopupContextItem, (ImGui_Context*,ctx)
(const char*,API_RO(str_id))
(int*,API_RO(popup_flags),ImGuiPopupFlags_MouseButtonRight),
...
API_FUNC(bool, BeginPopupContextWindow, (ImGui_Context*,ctx)
(const char*,API_RO(str_id))
(int*,API_RO(popup_flags),ImGuiPopupFlags_MouseButtonRight),
...
API_FUNC(bool, BeginTooltip, (ImGui_Context*,ctx),
...
API_FUNC(void, EndTooltip, (ImGui_Context*,ctx),
...
API_FUNC(void, SetTooltip, (ImGui_Context*,ctx)(const char*,text),
