...
DEFINE_ENUM(ImGui, Col_WindowBg,              "Background of normal windows. The alpha channel is ignored, use ImGui_WindowFlags_NoBackground for transparent windows instead.");
