...
API_FUNC(ImGui_DrawList*, GetWindowDrawList, (ImGui_Context*,ctx),
...
API_FUNC(ImGui_DrawList*, GetBackgroundDrawList, (ImGui_Context*,ctx),
...
API_FUNC(ImGui_DrawList*, GetForegroundDrawList, (ImGui_Context*,ctx),
...
API_FUNC(void, DrawList_PushClipRect, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PushClipRectFullScreen, (ImGui_DrawList*,draw_list),
"")
{
  draw_list->get()->PushClipRectFullScreen();
}

API_FUNC(void, DrawList_PopClipRect, (ImGui_DrawList*,draw_list),
"See DrawList_PushClipRect")
{
  draw_list->get()->PopClipRect();
}

API_ENUM(Im, DrawFlags_None, "");
API_ENUM(Im, DrawFlags_Closed,
...
API_ENUM(Im, DrawFlags_RoundCornersTopLeft,
...
API_ENUM(Im, DrawFlags_RoundCornersTop,    "");
API_ENUM(Im, DrawFlags_RoundCornersBottom, "");
API_ENUM(Im, DrawFlags_RoundCornersLeft,   "");
API_ENUM(Im, DrawFlags_RoundCornersRight,  "");
API_ENUM(Im, DrawFlags_RoundCornersAll,    "");
...
API_FUNC(void, DrawList_AddLine, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddRect, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddRectFilled, (ImGui_DrawList*,draw_list)
(double,p_min_x)(double,p_min_y)(double,p_max_x)(double,p_max_y)(int,col_rgba)
(double*,API_RO(rounding),0.0)(int*,API_RO(flags),ImDrawFlags_None),
"")
{
...
API_FUNC(void, DrawList_AddRectFilledMultiColor, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddQuad, (ImGui_DrawList*,draw_list)
(double,p1_x)(double,p1_y)(double,p2_x)(double,p2_y)
...
API_FUNC(void, DrawList_AddQuadFilled, (ImGui_DrawList*,draw_list)
(double,p1_x)(double,p1_y)(double,p2_x)(double,p2_y)
(double,p3_x)(double,p3_y)(double,p4_x)(double,p4_y)
(int,col_rgba),
"")
...
API_FUNC(void, DrawList_AddTriangle, (ImGui_DrawList*,draw_list)
(double,p1_x)(double,p1_y)(double,p2_x)(double,p2_y)
...
API_FUNC(void, DrawList_AddTriangleFilled, (ImGui_DrawList*,draw_list)
(double,p1_x)(double,p1_y)(double,p2_x)(double,p2_y)
...
API_FUNC(void, DrawList_AddCircle, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddCircleFilled, (ImGui_DrawList*,draw_list)
(double,center_x)(double,center_y)(double,radius)(int,col_rgba)
...
API_FUNC(void, DrawList_AddNgon, (ImGui_DrawList*,draw_list)
(double,center_x)(double,center_y)(double,radius)(int,col_rgba)
...
API_FUNC(void, DrawList_AddNgonFilled, (ImGui_DrawList*,draw_list)
(double,center_x)(double,center_y)(double,radius)(int,col_rgba)
(int,num_segments),
"")
{
...
API_FUNC(void, DrawList_AddText, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddTextEx, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddPolyline, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddConvexPolyFilled, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddBezierCubic, (ImGui_DrawList*,draw_list)
(double,p1_x)(double,p1_y)(double,p2_x)(double,p2_y)
(double,p3_x)(double,p3_y)(double,p4_x)(double,p4_y)
...
API_FUNC(void, DrawList_AddBezierQuadratic, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddImage, (ImGui_DrawList*,draw_list)
(ImGui_Image*,img)
(double,p_min_x)(double,p_min_y)(double,p_max_x)(double,p_max_y)
...
API_FUNC(void, DrawList_AddImageQuad, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_AddImageRounded, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathClear, (ImGui_DrawList*,draw_list),
"")
{
  draw_list->get()->PathClear();
}

API_FUNC(void, DrawList_PathLineTo, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathFillConvex, (ImGui_DrawList*,draw_list)
(int,col_rgba),
"Note: Anti-aliased filling requires points to be in clockwise order.")
{
...
API_FUNC(void, DrawList_PathStroke, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathArcTo, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathArcToFast, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathBezierCubicCurveTo, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathBezierQuadraticCurveTo, (ImGui_DrawList*,draw_list)
...
API_FUNC(void, DrawList_PathRect, (ImGui_DrawList*,draw_list)
...
API_FUNC(ImGui_DrawListSplitter*, CreateDrawListSplitter,
...
API_FUNC(void, DrawListSplitter_Clear, (ImGui_DrawListSplitter*,splitter),
"")
{
  (*splitter)->Clear();
}

API_FUNC(void, DrawListSplitter_Split, (ImGui_DrawListSplitter*,splitter)
(int,count),
"")
{
...
API_FUNC(void, DrawListSplitter_Merge, (ImGui_DrawListSplitter*,splitter),
"")
{
  (*splitter)->Merge(splitter->drawList());
}

API_FUNC(void, DrawListSplitter_SetCurrentChannel,
