...
API_ENUM(0_6, Key_LeftCtrl,   "See also Mod_Ctrl");
API_ENUM(0_6, Key_LeftShift,  "See also Mod_Shift");
API_ENUM(0_6, Key_LeftAlt,    "See also Mod_Alt");
API_ENUM(0_6, Key_LeftSuper,  "See also Mod_Super");
API_ENUM(0_6, Key_RightCtrl,  "See also Mod_Ctrl");
API_ENUM(0_6, Key_RightShift, "See also Mod_Shift");
API_ENUM(0_6, Key_RightAlt,   "See also Mod_Alt");
API_ENUM(0_6, Key_RightSuper, "See also Mod_Super");
API_ENUM(0_6, Key_Menu,       "Also known as the application key");
API_ENUM(0_6, Key_0, "");
API_ENUM(0_6, Key_1, "");
API_ENUM(0_6, Key_2, "");
API_ENUM(0_6, Key_3, "");
