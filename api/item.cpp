...
DEFINE_API(__LINE__, void, GetItemRectMax, (ImGui_Context*,ctx)
(double*,API_W(x))(double*,API_W(y)),
...
DEFINE_API(__LINE__, void, GetItemRectSize, (ImGui_Context*,ctx)
...
DEFINE_API(__LINE__, void, SetItemAllowOverlap, (ImGui_Context*,ctx),
...
// Focus, Activation
DEFINE_API(__LINE__, void, SetItemDefaultFocus, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, void, SetKeyboardFocusHere, (ImGui_Context*,ctx)
(int*,API_RO(offset)),
...
DEFINE_API(__LINE__, void, PushAllowKeyboardFocus, (ImGui_Context*,ctx)
...
DEFINE_API(__LINE__, void, PopAllowKeyboardFocus, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, void, PushItemWidth, (ImGui_Context*,ctx)
(double,item_width),
...
DEFINE_API(__LINE__, void, PopItemWidth, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, void, SetNextItemWidth, (ImGui_Context*,ctx)
(double,item_width),
...
DEFINE_API(__LINE__, double, CalcItemWidth, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemHovered, (ImGui_Context*,ctx)(int*,API_RO(flags)),
...
DEFINE_API(__LINE__, bool, IsItemActive, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemFocused, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemClicked, (ImGui_Context*,ctx)(int*,API_RO(mouse_button)),
...
DEFINE_API(__LINE__, bool, IsItemVisible, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemEdited, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemActivated, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemDeactivated, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsItemDeactivatedAfterEdit, (ImGui_Context*,ctx),
...
DEFINE_API(__LINE__, bool, IsAnyItemHovered, (ImGui_Context*,ctx),
"",
{
  FRAME_GUARD;
...
DEFINE_API(__LINE__, bool, IsAnyItemActive, (ImGui_Context*,ctx),
"",
{
  FRAME_GUARD;
...
DEFINE_API(__LINE__, bool, IsAnyItemFocused, (ImGui_Context*,ctx),
"",
{
  FRAME_GUARD;
