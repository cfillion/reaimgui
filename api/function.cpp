...
API_FUNC(ImGui_Function*, CreateFunctionFromEEL, (const char*,code),
...
API_FUNC(void, Function_Execute, (ImGui_Function*,func),
"")
{
  assertValid(func);
  func->execute();
...
API_FUNC(double, Function_GetValue, (ImGui_Function*,func)(const char*,name),
"")
{
  assertValid(func);
...
API_FUNC(void, Function_SetValue, (ImGui_Function*,func)
...
API_FUNC(void, Function_GetValue_Array, (ImGui_Function*,func)
...
API_FUNC(void, Function_SetValue_Array, (ImGui_Function*,func)
(const char*,name)(reaper_array*,values),
...
API_FUNC(void, Function_GetValue_String, (ImGui_Function*,func)
...
API_FUNC(void, Function_SetValue_String, (ImGui_Function*,func)
