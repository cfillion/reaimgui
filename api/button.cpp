...
REAIMGUI_API
bool SmallButton(ImGui_Context *ctx, const char *label)
{
  FRAME_GUARD;
...
REAIMGUI_API
bool InvisibleButton(ImGui_Context *ctx,
...
REAIMGUI_API
bool ArrowButton(ImGui_Context *ctx, const char *str_id, int dir)
{
  FRAME_GUARD;
...
REAIMGUI_API
bool Checkbox(ImGui_Context *ctx, const char *label, bool *API_RW(v))
{
  FRAME_GUARD;
  if(!API_RW(v))
    return false;
...
REAIMGUI_API
bool CheckboxFlags(ImGui_Context *ctx,
...
REAIMGUI_API
bool RadioButton(ImGui_Context *ctx,
...
REAIMGUI_API
bool RadioButtonEx(ImGui_Context *ctx,
...
REAIMGUI_API
void PushButtonRepeat(ImGui_Context *ctx, bool repeat)
{
  FRAME_GUARD;
...
REAIMGUI_API
void PopButtonRepeat(ImGui_Context *ctx)
{
  FRAME_GUARD;
  ImGui::PopButtonRepeat();
}

REAIMGUI_CONST(ImGui, ButtonFlags_None,              "Flags for ImGui_InvisibleButton.")
REAIMGUI_CONST(ImGui, ButtonFlags_MouseButtonLeft,   "React on left mouse button (default).")
REAIMGUI_CONST(ImGui, ButtonFlags_MouseButtonRight,  "React on right mouse button.")
REAIMGUI_CONST(ImGui, ButtonFlags_MouseButtonMiddle, "React on center mouse button.")
