...
API_FUNC(bool, Button, (ImGui_Context*,ctx)
...
API_FUNC(bool, SmallButton, (ImGui_Context*,ctx)
(const char*,label),
...
API_FUNC(bool, InvisibleButton, (ImGui_Context*,ctx)
...
API_FUNC(bool, ArrowButton, (ImGui_Context*,ctx)
...
API_FUNC(bool, Checkbox, (ImGui_Context*,ctx)
...
API_FUNC(bool, CheckboxFlags, (ImGui_Context*,ctx)
...
API_FUNC(bool, RadioButton, (ImGui_Context*,ctx)
...
API_FUNC(bool, RadioButtonEx, (ImGui_Context*,ctx)
...
API_FUNC(void, PushButtonRepeat, (ImGui_Context*,ctx)
(bool,repeat),
...
API_FUNC(void, PopButtonRepeat, (ImGui_Context*,ctx),
...
API_ENUM(ImGui, ButtonFlags_None, "");
API_ENUM(ImGui, ButtonFlags_MouseButtonLeft,
  "React on left mouse button (default).");
API_ENUM(ImGui, ButtonFlags_MouseButtonRight,
  "React on right mouse button.");
API_ENUM(ImGui, ButtonFlags_MouseButtonMiddle,
  "React on center mouse button.");

API_SUBSECTION("Cardinal directions", "For ArrowButton.");
API_ENUM(ImGui, Dir_None,  "");
API_ENUM(ImGui, Dir_Left,  "");
API_ENUM(ImGui, Dir_Right, "");
API_ENUM(ImGui, Dir_Up,    "");
API_ENUM(ImGui, Dir_Down,  "");
