...
R"(Set next window position. Use pivot=(0.5,0.5) to center on given point, etc.
...
R"(Set next window size. set axis to 0.0 to force an auto-fit on this axis.
...
R"(Set next window collapsed state.
