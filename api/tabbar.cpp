...
API_FUNC(bool, BeginTabBar, (ImGui_Context*,ctx)
...
API_FUNC(void, EndTabBar, (ImGui_Context*,ctx),
...
API_ENUM(ImGui, TabBarFlags_None, "");
API_ENUM(ImGui, TabBarFlags_Reorderable,
R"(Allow manually dragging tabs to re-order them + New tabs are appended at
   the end of list.)");
API_ENUM(ImGui, TabBarFlags_AutoSelectNewTabs,
  "Automatically select new tabs when they appear.");
API_ENUM(ImGui, TabBarFlags_TabListPopupButton,
  "Disable buttons to open the tab list popup.");
API_ENUM(ImGui, TabBarFlags_NoCloseWithMiddleMouseButton,
...
API_ENUM(ImGui, TabBarFlags_NoTabListScrollingButtons,
R"(Disable scrolling buttons (apply when fitting policy is
   TabBarFlags_FittingPolicyScroll).)");
API_ENUM(ImGui, TabBarFlags_NoTooltip,
  "Disable tooltips when hovering a tab.");
API_ENUM(ImGui, TabBarFlags_FittingPolicyResizeDown,
  "Resize tabs when they don't fit.");
API_ENUM(ImGui, TabBarFlags_FittingPolicyScroll,
  "Add scroll buttons when tabs don't fit.");

API_SUBSECTION("Tab Item");

API_FUNC(bool, BeginTabItem, (ImGui_Context*,ctx)
...
API_FUNC(void, EndTabItem, (ImGui_Context*,ctx),
...
API_FUNC(bool, TabItemButton, (ImGui_Context*,ctx)
...
API_FUNC(void, SetTabItemClosed, (ImGui_Context*,ctx)
...
API_ENUM(ImGui, TabItemFlags_None,                         "");
API_ENUM(ImGui, TabItemFlags_UnsavedDocument,
...
API_ENUM(ImGui, TabItemFlags_SetSelected,
  "Trigger flag to programmatically make the tab selected when calling BeginTabItem.");
API_ENUM(ImGui, TabItemFlags_NoCloseWithMiddleMouseButton,
...
API_ENUM(ImGui, TabItemFlags_NoPushId,
  "Don't call PushID(tab->ID)/PopID() on BeginTabItem/EndTabItem.");
API_ENUM(ImGui, TabItemFlags_NoTooltip,
  "Disable tooltip for the given tab.");
API_ENUM(ImGui, TabItemFlags_NoReorder,
  "Disable reordering this tab or having another tab cross over this tab.");
API_ENUM(ImGui, TabItemFlags_Leading,
  "Enforce the tab position to the left of the tab bar (after the tab list popup button).");
API_ENUM(ImGui, TabItemFlags_Trailing,
