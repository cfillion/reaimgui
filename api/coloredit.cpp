...
API_FUNC(bool, ColorEdit4, (ImGui_Context*,ctx)
...
API_FUNC(bool, ColorEdit3, (ImGui_Context*,ctx)
...
API_FUNC(bool, ColorPicker4, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(col_rgba))
...
API_FUNC(bool, ColorPicker3, (ImGui_Context*,ctx)
(const char*,label)(int*,API_RW(col_rgb))
(int*,API_RO(flags),ImGuiColorEditFlags_None),
...
API_FUNC(bool, ColorButton, (ImGui_Context*,ctx)
...
API_FUNC(void, SetColorEditOptions, (ImGui_Context*,ctx)
(int,flags),
...
API_ENUM(ImGui, ColorEditFlags_PickerHueBar,
  "ColorPicker: bar for Hue, rectangle for Sat/Value.");
API_ENUM(ImGui, ColorEditFlags_PickerHueWheel,
  "ColorPicker: wheel for Hue, triangle for Sat/Value.");
API_ENUM(ImGui, ColorEditFlags_InputRGB,
  "ColorEdit, ColorPicker: input and output data in RGB format.");
API_ENUM(ImGui, ColorEditFlags_InputHSV,
